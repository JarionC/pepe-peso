        ...
        <div className="wrapper">
            <div className="container">
                ...
                <div className="media-container">
                    <div className="main-title">PePePeso</div>
                    <div className="main-img">
                    <div className={"sound-btn home " + (isMuted ? "muted" : "unmuted")} onClick={toggleAudio}>
          </div>
                    </div>
                ...
                <div className="text-container">
                    <div className="title">PePe Peso: Crossing borders, breaking down walls, and turning lazy afternoons into a goldmine!</div>
                    <div className="body">
                    Welcome, amigo, to the vibrant world of PePe Peso! Ever dreamt of crossing the border of mediocrity, smashing through the walls of the mundane, and chilling on a beach with a burrito, all while your PePe Pesos pile up? You're at the right place! We're taking the fun of Mexican culture and blending it with the exciting universe of crypto. So, get ready to work hard, relax harder, and let's make some Pesos together!
                    <br></br><br></br>
            ...
            <div className="container-two">
                ...
                Ready for a sneak peek at what's coming up? Our roadmap is all about making waves and crossing borders, with the fun of a mariachi band and the thrill of a nighttime border dash. We've got plans to grow our community, broaden our horizons, and partner with some cultural hotspots. So, buckle up for a wild ride with PePe Peso, where we turn a lazy beach day into a wallet-fattening fiesta!
                </div>
                ...
                <div className="inner-three">
                    ...
                    <div className="roadmap-section token">
                        <ul className="roadmap-list tokenomics">
                            <li className="roadmap-list-item">1.92% tax, in honor of Mexico, on each transaction.</li>
